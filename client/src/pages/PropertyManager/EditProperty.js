...
function EditProperty(){
    ...
    const {paramPM_SIN, paramPropertyNo} = useParams();
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        if (!NoOfUnits || !City || !Country || !Street || !Postal_Code) {
        ...
        setTimeout(() => navigate(`/propertyManager/manage-properties/${paramPM_SIN}`), 500);
    };
